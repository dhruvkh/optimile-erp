...
const CustomerLedger: React.FC = () => {
  ...
  const handleGenerateInvoice = () => {
    ...
    if (uniqueCustomers.size > 1) {
      showToast({ type: 'warning', title: 'Selection Error', message: 'Please select trips for the same customer to generate a single invoice.' });
      return;
    }
    navigate('/finance/invoices/create', { state: { selectedBookings } });
  };
