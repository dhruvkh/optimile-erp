...
const navItems: NavItem[] = [
  { label: 'Dashboard', icon: 'dashboard', path: '/finance/dashboard', allowedRoles: ['Admin', 'Finance Manager', 'Accountant', 'Operations Manager'] },
  { label: 'Customer Ledger', icon: 'account_balance_wallet', path: '/finance/customers', allowedRoles: ['Admin', 'Finance Manager', 'Accountant'] },
  { label: 'Invoices', icon: 'receipt', path: '/finance/invoices', allowedRoles: ['Admin', 'Finance Manager', 'Accountant'] },
  { label: 'Vendor Ledger', icon: 'store', path: '/finance/vendors', allowedRoles: ['Admin', 'Finance Manager', 'Accountant'] },
  { label: 'Fleet Ledger', icon: 'directions_car', path: '/finance/fleet-ledger', allowedRoles: ['Admin', 'Finance Manager', 'Accountant', 'Operations Manager'] },
  { label: 'Reconciliation', icon: 'sync_alt', path: '/finance/reconciliation', allowedRoles: ['Admin', 'Finance Manager'] },
  { label: 'Approval Matrix', icon: 'verified_user', path: '/finance/approval-matrix', allowedRoles: ['Admin', 'Finance Manager', 'Accountant'] },
  { label: 'Reports', icon: 'bar_chart', path: '/finance/reports', allowedRoles: ['Admin', 'Finance Manager', 'Accountant'] },
  { label: 'Settings', icon: 'settings', path: '/finance/settings', allowedRoles: ['Admin', 'Finance Manager'] },
];
